...
public class MouseCameraScript : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        transform.Rotate(0, Sensitivity * MouseInput.x, 0);
        ...
        PlayerCamera.transform.localRotation = Quaternion.Euler(MouseRotationX , 0 , 0);

        //Constantly have the visiblity of the cursor to be false;
        Cursor.visible = false;

        //Locks the cursor FINALLY LETS GOOOOOOOOOOOO!!!!! WOOOOOOOOOOOOOOOOOOOOO!!!!!!!!!!!!!!!!!!!!!!!!!!!
